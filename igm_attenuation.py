...
inoue_coeffs = np.genfromtxt(extractBC03Root + '/inoue_coeffs.dat',dtype=[('j',int),('lambda',float),('A1_LAF',float),('A2_LAF',float),('A3_LAF',float),('A1_DLA',float),('A2_DLA',float)],unpack=True)
